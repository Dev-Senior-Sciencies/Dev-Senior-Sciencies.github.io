...
const videoA3 = document.getElementById('videoA3');
const video4 = document.getElementById('video4');
const videoA4 = document.getElementById('videoA4');
const video5 = document.getElementById('video5');
const videoA5 = document.getElementById('videoA5');
const video6 = document.getElementById('video6');
const videoA6 = document.getElementById('videoA6');
const video7 = document.getElementById('video7');
const videoA7 = document.getElementById('videoA7');
const video8 = document.getElementById('video8');
const videoA8 = document.getElementById('videoA8');

function myHidlle() {
  video1.setAttribute('hidden', 'hidden');
  video2.setAttribute('hidden', 'hidden');
  video3.setAttribute('hidden', 'hidden');
  video4.setAttribute('hidden', 'hidden');
  video5.setAttribute('hidden', 'hidden');
  video6.setAttribute('hidden', 'hidden');
  video7.setAttribute('hidden', 'hidden');
  video8.setAttribute('hidden', 'hidden');
}

videoA1.addEventListener('click', function videoA1Click() {
  video1.removeAttribute('hidden');
  ...
  video7.removeAttribute('hidden');
  video8.removeAttribute('hidden');
})

// play Video 2 //
videoA2.addEventListener('click', function videoA1Click() {
  video1.removeAttribute('hidden');
  video2.removeAttribute('hidden');
  video3.removeAttribute('hidden');
  video4.removeAttribute('hidden');
...
// play Video 3 //
videoA3.addEventListener('click', function videoA1Click() {
  video1.removeAttribute('hidden');
  video2.removeAttribute('hidden');
  video3.removeAttribute('hidden');
  video4.removeAttribute('hidden');
...
// play Video 4 //
videoA4.addEventListener('click', function videoA1Click() {
  video1.removeAttribute('hidden');
  video2.removeAttribute('hidden');
  video3.removeAttribute('hidden');
  video4.removeAttribute('hidden');
...
// play Video 5 //
videoA5.addEventListener('click', function videoA1Click() {
  video1.removeAttribute('hidden');
  video2.removeAttribute('hidden');
  video3.removeAttribute('hidden');
  video4.removeAttribute('hidden');
...
// play Video 6 //
videoA6.addEventListener('click', function videoA1Click() {
  video1.removeAttribute('hidden');
  video2.removeAttribute('hidden');
  video3.removeAttribute('hidden');
  video4.removeAttribute('hidden');
...
// play Video 7 //
videoA7.addEventListener('click', function videoA1Click() {
  video1.removeAttribute('hidden');
  video2.removeAttribute('hidden');
  video3.removeAttribute('hidden');
  video4.removeAttribute('hidden');
...
// play Video 8 //
videoA8.addEventListener('click', function videoA1Click() {
  video1.removeAttribute('hidden');
  video2.removeAttribute('hidden');
  video3.removeAttribute('hidden');
  video4.removeAttribute('hidden');
